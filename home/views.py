...
from blogApp.settings import EMAIL_HOST_USER
import random
import re
...
def index (request):
    ...
    random_blogs = random.sample(list(blogs),4)
    ...
    if request.method == 'POST':
        ...
        if name in invalid_imput or email in invalid_imput or phone in invalid_imput or message in invalid_imput:
            ...
            if email_pattern.match(email) and phone_pattern.match(phone):
                ...
                from_email = 'portfoliocontact246@gmail.com'
                recipient_list = ['rahularyan0197@gmail.com']
